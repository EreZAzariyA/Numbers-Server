...
exports.RecurringPatterns = void 0;
const mongoose_1 = require("mongoose");
const RecurringPatternsSchema = new mongoose_1.Schema({
    user_id: {
...
RecurringPatternsSchema.index({ user_id: 1, 'installmentPlan.paymentsRemaining': 1 }, { partialFilterExpression: { installmentPlan: { $ne: null } } });
exports.RecurringPatterns = (0, mongoose_1.model)('RecurringPatterns', RecurringPatternsSchema, 'recurringPatterns');
