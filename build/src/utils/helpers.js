...
exports.asNumString = exports.getFutureDebitDate = exports.isArrayAndNotEmpty = exports.isArray = exports.removeServicesFromUser = exports.getTotalTransactionsAmounts = exports.isCardProviderCompany = exports.isSupportedCompany = exports.getLogLevel = exports.getLogger = exports.ENV_TYPE = exports.CreditCardProviders = exports.SupportedCompanies = exports.ErrorMessages = exports.Languages = exports.ThemeColors = exports.MAX_LOGIN_ATTEMPTS = void 0;
...
exports.SupportedCompanies = {
    [israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.discount]: israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.discount,
    [israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.max]: israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.max,
    [israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.behatsdaa]: israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.behatsdaa,
    [israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.leumi]: israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.leumi,
    [israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.visaCal]: israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.visaCal,
};
exports.CreditCardProviders = [
    israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.visaCal,
    israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.max,
    israeli_bank_scrapers_for_e_a_servers_1.CompanyTypes.behatsdaa,
];
var ENV_TYPE;
(function (ENV_TYPE) {
    ENV_TYPE["DEVELOPMENT"] = "development";
    ENV_TYPE["PRODUCTION"] = "production";
})(ENV_TYPE || (exports.ENV_TYPE = ENV_TYPE = {}));
;
;
...
const getLogLevel = (envType) => {
    return envType === ENV_TYPE.DEVELOPMENT ? "debug" : "info";
};
exports.getLogLevel = getLogLevel;
const isSupportedCompany = (company) => {
    return Boolean(company && company in exports.SupportedCompanies);
};
exports.isSupportedCompany = isSupportedCompany;
const isCardProviderCompany = (company) => {
    if (!(0, exports.isSupportedCompany)(company))
        return false;
    return exports.CreditCardProviders.includes(company);
};
