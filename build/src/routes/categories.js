...
router.get("/:user_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const categories = yield bll_1.categoriesLogic.fetchCategoriesByUserId(user_id);
...
router.post("/:user_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const addedCategory = yield bll_1.categoriesLogic.addNewCategory(categoryName, user_id);
...
router.put("/:user_id", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const updatedCategory = yield bll_1.categoriesLogic.updateCategory(categoryToUpdate, user_id);
...
router.delete("/", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield bll_1.categoriesLogic.removeCategory(category_id, user_id);
        res.sendStatus(200);
    }
    catch (err) {
        next(err);
